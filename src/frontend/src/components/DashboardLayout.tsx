...
import { 
  ...
  Bell,
  GraduationCap,
  UserPlus // 1. Import de l'icône pour l'ajout
} from 'lucide-react';
...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  // Configuration du menu spécifique aux Professeurs
  const menuItems = [
    { icon: LayoutDashboard, label: "Tableau de bord", path: "/" },
    // 2. Ajout du lien vers la page d'ajout
    { icon: UserPlus, label: "Ajouter Professeur", path: "/add-professor" },
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex font-sans text-gray-800">
      ...
      <aside 
        className={`bg-white border-r border-gray-200 transition-all duration-300 ease-in-out flex flex-col
          ...
          fixed h-full z-20 left-0 top-0 hidden md:flex shadow-sm`}
      >
        {/* Logo */}
