...
interface DashboardLayoutProps {
  ...
  role?: string; // Le rôle est passé depuis App.tsx
}
...
export default function DashboardLayout({ children, role }: DashboardLayoutProps) {
  ...
  // Définition des menus spécifiques par rôle
  const getMenuItems = (role?: string) => {
    switch (role) {
      case "ADMINISTRATEUR":
        return [
          { icon: LayoutDashboard, label: "Dashboard Admin", route: "/admin" },
          { icon: Users, label: "Gérer Utilisateurs", route: "/admin" },
          { icon: GraduationCap, label: "Gérer Modules", route: "/admin" },
        ];
      case "PROFESSEUR":
        return [
          { icon: LayoutDashboard, label: "Espace Prof", route: "/professeur" },
          { icon: BookMarked, label: "Gérer Notes", route: "/professeur" },
          { icon: Users, label: "Mes Étudiants", route: "/professeur" },
        ];
      case "ETUDIANT":
        return [
          { icon: LayoutDashboard, label: "Mon Espace", route: "/etudiant" },
          { icon: BookMarked, label: "Mes Notes", route: "/etudiant" },
          { icon: GraduationCap, label: "Mes Cours", route: "/etudiant" },
        ];
      default:
        return [];
    }
